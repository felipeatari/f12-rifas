        ...
        <main class="p-6">
            ...
            <form id="meus-sorteios" class="mb-8">
                <div class="flex justify-between mb-4">
                    ...
                    <button
                        class="w-[200px] bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Cadastrar</button>
                </div>
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="p-3 border-b text-center flex">
                                <button class="w-[300px] bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600 mr-1">Filtrar</button>
                                <a href="{{ route('affiliate') }}" class="w-[300px] bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600 font-normal">Limpar</a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-3 border-b flex">
                                <button
                                    class="w-[300px] bg-blue-500 text-white px-3 py-1 mr-1 rounded hover:bg-blue-600">Ver</button>
                                <button
                                    class="w-[300px] bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Divulgar</button>
                            </td>
                        </tr>
                        @empty
                            <tr>
