...
<body class="bg-white text-gray-800">
    <!-- Navbar -->
    <header class="w-full bg-gray-900 text-white shadow fixed">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="space-x-6">
                ...
                <a href="#vantagens" class="hover:text-yellow-400">Vantagens</a>
                <a href="#taxas" class="hover:text-yellow-400">Comissões</a>
